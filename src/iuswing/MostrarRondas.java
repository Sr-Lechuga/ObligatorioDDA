...
import vistas.VistaRonda;

/**
 *
 * @author agust
 */
public class MostrarRondas extends javax.swing.JFrame implements VistaRonda {

    public MostrarRondas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MostrarRondas.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MostrarRondas().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JList<String> listInfoRondas;
